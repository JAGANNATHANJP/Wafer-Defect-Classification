"""
train_resnet50_v3.py
=========================================================
Standalone ResNet50 V3 Training Script
...
report_file = os.path.join(
    REPORT_DIR,
    "resnet50_v3_classification_report.txt",
)
...
cm_file = os.path.join(
    PLOT_DIR,
    "resnet50_v3_confusion_matrix.png",
)
...
curve_file = os.path.join(
    PLOT_DIR,
    "resnet50_v3_training_curves.png",
)
...
print("\n" + "=" * 60)
print("RESNET50 V3 TRAINING COMPLETED SUCCESSFULLY")
print("=" * 60)
